...
*/
	...
	<body>
		...
		<div class="fh5co-hero">
			...
			<div id="maincnt" class="fh5co-cover" data-stellar-background-ratio="1.0" style="overflow:auto;color:red;font-size:x-large;background-image: url(images/cover_bg_1.jpg);">
			<div id="inner" style="position:absolute;top:150px;left:30px">
